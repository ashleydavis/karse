...
// whole and fractional cores ("1" -> 1000, "1.5" -> 1500), and the nanocore form the
// Metrics API returns ("123456789n" -> 123, floored after dividing by 1e6). An empty
// string yields 0. Any other non-empty value throws.
