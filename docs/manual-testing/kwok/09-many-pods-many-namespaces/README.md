...
- **Pods page per namespace**: with `team-1` active, exactly 4 pods are shown and the Namespace column is hidden.
- **All namespaces**: open the namespace picker and click "All namespaces" — all 20 pods appear with the Namespace column restored.
