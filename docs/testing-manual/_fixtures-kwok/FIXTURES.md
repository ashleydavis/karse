...
| [38-generic-detail](38-generic-detail/) | Kinds with no detail page of their own: a namespaced autoscaler, service and job in `default`, plus a cluster-scoped persistent volume | generic-detail |
