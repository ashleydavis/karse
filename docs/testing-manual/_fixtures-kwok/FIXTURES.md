...
| [36-large-pod-list](36-large-pod-list/) | One namespace (`bigpods`) holding a lot of real-cluster-shaped pods; the pod count is `setup.sh`'s first argument (default 1500) | resource-search |
