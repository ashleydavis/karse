...
- **Shareable URL state** (`detail.md`, "Shareable URL state"): page, resource, context, namespace, and table search all live in the URL. Fixture: [23-shareable-url-state](../_fixtures-kwok/23-shareable-url-state/).
