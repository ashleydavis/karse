...
| [copy-button](./copy-button/index.md) | Shared copy-to-clipboard controls beside pasteable values: the plain button, the two-entry copy menu (short name, full path), the rollout across every detail page and resource table, and the Commands / YAML tabs. |
