...
Karse is and how it works, states the author, and links to the GitHub repo. Also
covers the "Report a bug" entry that sits directly above it in the sidebar's
bottom section and opens the repository's new-issue page in a new tab.
