...
Manual tests for in-table search (fuzzy/subsequence on most tables, plain substring on events and errors), column sorting, and the 100-row rendered-row bound with its "Show more" control.
