...
- On release, the column lands exactly where the drop-target indicator showed, for both within-section reorders and moves between sections. A cross-section drop into the middle of the destination list lands at that middle position, not appended to the end.
