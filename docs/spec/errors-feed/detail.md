...
- The errors table's Object and Namespace columns, and the error detail page's Object and Namespace references, carry the two-form copy menu; the detail page's Reason and Message panel carry a plain copy button. See [copy-button](../copy-button/detail.md).
...
- [x] Each row's Object cell links to the referenced resource's detail page: its own page where it has one, the generic detail page otherwise.
