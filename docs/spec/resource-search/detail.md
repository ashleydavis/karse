...
Backed by: `frontend/src/lib/fuzzy-filter.ts`, `frontend/src/lib/errors-search.ts`, `frontend/src/lib/table-filter-state.ts`, `frontend/src/lib/use-table-filter.ts`, `frontend/src/lib/use-search-filter.ts`, `frontend/src/components/search-box.tsx`, `frontend/src/components/table-filter.tsx`, `frontend/src/components/data-table-row.tsx`, and the per-page table components under `frontend/src/pages/*/components/`.
