...
const columns: ColumnDef<StatefulSet>[] = [
    {
        ...
        cell: (info) => (
            <CopyNameCell
                ...
                label="stateful set name"
                testId="statefulset-row-name-copy"
            />
        ),
    },
    {
    ...
    },
    {
        ...
        header: "Labels",
        cell: (info) => <LabelsCell labels={info.row.original.labels} resourceKind="StatefulSet" resourceName={info.row.original.name} />,
        enableSorting: false,
...
export function StatefulSetsTable() {
    ...
    const openStatefulSet = useCallback((statefulSet: StatefulSet) => {
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <ScrollableTableContainer testId="statefulsets-table">
                <Table size="small">
                    <TableHead>
                    ...
                    <TableBody>
                        ...
                        <DataTableRows
                            ...
                            testId="statefulset-row"
                            clickable={true}
                            onOpen={openStatefulSet}
                        />
                    </TableBody>
                </Table>
