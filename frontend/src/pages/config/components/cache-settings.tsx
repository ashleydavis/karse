...
// The Config page's cluster-data cache tab. Exposes the staleness threshold (seconds) that
// decides how long cached kubectl data is served before Karse re-fetches it from the cluster.
// The value is persisted server-side.
